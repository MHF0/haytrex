...
All photographs in `assets/photos/` are real photos from the
[Open Images dataset](https://storage.googleapis.com/openimages/web/index.html),
each licensed [CC BY 2.0](https://creativecommons.org/licenses/by/2.0/)
(free for commercial use with attribution). Images were cropped/resized.
Keep this attribution list published (it is linked from the gallery page),
or replace the photos with your own and delete it.
...
| careers-workshop.jpg | Steve Saldivar | https://www.flickr.com/photos/stevesaldivar/3570010959 |
