        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <div className="flex">
              ...
              <input
                ...
                onChange={handleInputChange}
                className="flex-1 px-4 py-2 border border-gray-300 rounded-r-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
          ...
          {showOtpField && (
            <div className="mb-4">
              ...
              <div className="flex justify-between items-center mt-2">
                <p className="text-xs text-gray-500">OTP sent to +1 {formData.mobileNumber}</p>
                {otpTimer > 0 ? (
          ...
          >
            {isSubmitting ? (
              ...
              !showOtpField 
                ? (activeTab === 'login' ? 'Get OTP' : 'Create Account') 
                : 'Verify & Continue'
            )}
          </button>
