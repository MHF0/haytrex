    ...
    <div className="container mx-auto py-16 px-4">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Take the first step towards your business success. Choose the
          consultation option that best suits your needs.
        </p>
      </div>
      ...
      <div className="text-center mt-16">
        <h2 className="text-2xl font-semibold mb-4">
          Why Choose Haytrex Consultations?
        </h2>
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto mt-8">
          <div className="flex flex-col items-center p-6 rounded-lg bg-muted/50">
            ...
            <p className="text-center text-muted-foreground">
              Our team brings years of experience helping businesses thrive in
              competitive markets.
            </p>
          </div>
          <div className="flex flex-col items-center p-6 rounded-lg bg-muted/50">
            ...
            <p className="text-center text-muted-foreground">
              Walk away with concrete steps and strategies you can implement
              immediately.
            </p>
          </div>
          <div className="flex flex-col items-center p-6 rounded-lg bg-muted/50">
            ...
            <p className="text-center text-muted-foreground">
              Every business is unique. Our advice is customized to your
      ...
      <div className="mt-16 bg-muted/30 p-6 rounded-lg max-w-4xl mx-auto">
        ...
        <p className="text-muted-foreground">
          We're confident in the value we provide. If you're not satisfied with
          your paid consultation, we'll refund your investment. Our goal is to
          help you succeed, and we stand by the quality of our services.
        </p>
      </div>
    </div>
  );
